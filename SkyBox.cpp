...
void SkyBox::RotateSkybox(float fAngle, vec3 rotatedirection)
{
	this->fRangle = fAngle;
	this->Rotator = rotatedirection;
}
...
void SkyBox::loadSkybox(std::string a_sDirectory, std::string a_sFront, std::string a_sBack, std::string a_sLeft, std::string a_sRight, std::string a_sTop, std::string a_sBottom)
{
	...
	cubeMapTextures.push_back(a_sDirectory + a_sFront);
	cubeMapTextures.push_back(a_sDirectory + a_sBack);
	cubeMapTextures.push_back(a_sDirectory + a_sLeft);
	cubeMapTextures.push_back(a_sDirectory + a_sRight);
	cubeMapTextures.push_back(a_sDirectory + a_sTop);
	cubeMapTextures.push_back(a_sDirectory + a_sBottom);
...
void SkyBox::renderSkybox(CShaderProgram *sProgram)
{
	...
	ModelMatrix = glm::rotate(ModelMatrix, fRangle, Rotator);
